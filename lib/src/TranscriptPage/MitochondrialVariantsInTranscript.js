...
`;
const MitochondrialVariantsInTranscript = (_a) => {
    var { datasetId, transcript, zoomRegion = null } = _a, rest = __rest(_a, ["datasetId", "transcript", "zoomRegion"]);
    if (!(0, metadata_1.hasMitochondrialVariants)(datasetId)) {
        return (react_1.default.createElement(StatusMessage_1.default, null,
            ...
            react_1.default.createElement("br", null),
            react_1.default.createElement(Link_1.default, { to: `/transcript/${transcript.transcript_id}?dataset=gnomad_r3`, preserveSelectedDataset: false }, "View this transcript in gnomAD v3.1 to see mitochondrial variants")));
    }
    return (react_1.default.createElement(Query_1.default, { operationName: operationName, query: query, variables: {
        ...
        }, loadingMessage: "Loading variants", errorMessage: "Unable to load variants", success: (data) => data.transcript && data.transcript.mitochondrial_variants }, ({ data }) => {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            data.transcript.clinvar_variants.length > 0 ? (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(ClinvarVariantTrack_1.default, { referenceGenome: (0, metadata_1.referenceGenome)(datasetId), transcripts: [transcript], variants: (0, filterVariantsInZoomRegion_1.default)(data.transcript.clinvar_variants, zoomRegion) }),
            ...
            react_1.default.createElement(MitochondrialVariants_1.default, Object.assign({}, rest, { clinvarReleaseDate: data.meta.clinvar_release_date, context: transcript, exportFileName: `gnomad_mitochondrial_variants_${transcript.transcript_id}`, variants: (0, filterVariantsInZoomRegion_1.default)((0, annotateVariantsWithClinvar_1.default)(data.transcript.mitochondrial_variants, data.transcript.clinvar_variants), zoomRegion) }))));
    }));
};
MitochondrialVariantsInTranscript.defaultProps = {
    zoomRegion: null,
};
exports.default = MitochondrialVariantsInTranscript;
//# sourceMappingURL=MitochondrialVariantsInTranscript.js.map