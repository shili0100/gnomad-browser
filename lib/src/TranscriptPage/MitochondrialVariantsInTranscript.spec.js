...
(0, datasets_1.forAllDatasets)('MitochondrialVariantsInTranscript with dataset %s', (datasetId) => {
    (0, globals_1.test)('has no unexpected changes', () => {
        ...
        const tree = react_test_renderer_1.default.create(react_1.default.createElement(react_router_dom_1.BrowserRouter, null,
            react_1.default.createElement(MitochondrialVariantsInTranscript_1.default, { datasetId: datasetId, transcript: Transcript_1.default.build() })));
        (0, globals_1.expect)(tree).toMatchSnapshot();
    });
});
//# sourceMappingURL=MitochondrialVariantsInTranscript.spec.js.map