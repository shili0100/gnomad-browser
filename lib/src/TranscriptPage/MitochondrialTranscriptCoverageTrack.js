...
const MitochondrialTranscriptCoverageTrack = ({ datasetId, transcriptId }) => {
    ...
    return (react_1.default.createElement(Query_1.default, { operationName: operationName, query: query, variables: { transcriptId, datasetId, referenceGenome: (0, metadata_1.referenceGenome)(datasetId) }, loadingMessage: "Loading coverage", loadingPlaceholderHeight: 220, errorMessage: "Unable to load coverage", success: (data) => data.transcript && data.transcript.mitochondrial_coverage }, ({ data }) => {
        const coverage = [
            {
        ...
        return (react_1.default.createElement(CoverageTrack_1.default, { coverageOverThresholds: [100, 1000], datasets: coverage, filenameForExport: () => `${transcriptId}_coverage`, height: 190, maxCoverage: 3000, datasetId: datasetId, metric: CoverageTrack_1.MetricOptions.mean }));
    }));
};
exports.default = MitochondrialTranscriptCoverageTrack;
//# sourceMappingURL=MitochondrialTranscriptCoverageTrack.js.map