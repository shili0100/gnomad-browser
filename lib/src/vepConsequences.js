...
exports.registerConsequences = exports.getConsequenceRank = exports.getLabelForConsequenceTerm = exports.getCategoryFromConsequence = exports.VEP_CONSEQUENCE_CATEGORY_LABELS = exports.VEP_CONSEQUENCE_CATEGORIES = void 0;
...
exports.VEP_CONSEQUENCE_CATEGORIES = ['lof', 'missense', 'synonymous', 'other'];
exports.VEP_CONSEQUENCE_CATEGORY_LABELS = {
    lof: 'pLoF',
    missense: 'Missense / Inframe indel',
    synonymous: 'Synonymous',
    other: 'Other',
};
const getCategoryFromConsequence = (consequenceTerm) => categoryByTerm[consequenceTerm];
exports.getCategoryFromConsequence = getCategoryFromConsequence;
const getLabelForConsequenceTerm = (consequenceTerm) => labelByTerm[consequenceTerm] || consequenceTerm;
exports.getLabelForConsequenceTerm = getLabelForConsequenceTerm;
const getConsequenceRank = (consequenceTerm) => rankedVepConsequences.findIndex((consequence) => consequence.term === consequenceTerm);
exports.getConsequenceRank = getConsequenceRank;
const registerConsequences = (consequences) => {
    consequences.forEach((consequence) => {
        categoryByTerm[consequence.term] = consequence.category;
        labelByTerm[consequence.term] = consequence.label;
    });
};
exports.registerConsequences = registerConsequences;
(0, exports.registerConsequences)(rankedVepConsequences);
//# sourceMappingURL=vepConsequences.js.map