...
const StructuralVariantsTable = (_a) => {
    ...
    return (react_1.default.createElement(ui_1.Grid, Object.assign({ ref: forwardedRef }, rest, { columns: columns, data: variants, numRowsRendered: numRowsRendered, onHoverRow: (rowIndex) => {
            onHoverVariant(rowIndex === null ? null : variants[rowIndex].variant_id);
        }, rowHeight: rowHeight, rowKey: (variant) => variant.variant_id })));
};
const MemoizedStructuralVariantsTable = (0, react_1.memo)(StructuralVariantsTable);
...
react_1.default.createElement(MemoizedStructuralVariantsTable, Object.assign({}, props, { forwardedRef: ref }))));
//# sourceMappingURL=StructuralVariantsTable.js.map