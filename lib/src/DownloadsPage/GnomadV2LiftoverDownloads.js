...
const Gnomadv2LiftoverDownloads = () => {
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(downloadsPageStyles_1.SectionTitle, { id: "v2-liftover", theme: { type: 'release' } }, "v2 Liftover Downloads"),
        react_1.default.createElement(downloadsPageStyles_1.StyledParagraph, null, "The gnomAD v2.1.1 liftover data set contains data from 125,748 exomes and 15,708 whole genomes, lifted over from the GRCh37 to the GRCh38 reference sequence."),
        react_1.default.createElement(downloadsPageStyles_1.SectionTitle, { id: "v2-liftover-core-dataset", theme: { type: 'datasets' } }, "Core Dataset"),
        ...
        react_1.default.createElement(downloadsPageStyles_1.DownloadsSection, null,
            react_1.default.createElement(downloadsPageStyles_1.SectionTitle, { id: "v2-liftover-variants" }, "Variants (GRCh38 liftover)"),
                ...
                react_1.default.createElement(downloadsPageStyles_1.Column, null,
                    ...
                    react_1.default.createElement(downloadsPageStyles_1.FileList, null,
                        react_1.default.createElement(ui_1.ListItem, null,
                            react_1.default.createElement(downloadsPageStyles_1.GetUrlButtons, { label: "Sites Hail Table", path: "/release/2.1.1/liftover_grch38/ht/exomes/gnomad.exomes.r2.1.1.sites.liftover_grch38.ht" })),
                        react_1.default.createElement(ui_1.ListItem, null,
                            react_1.default.createElement(downloadsPageStyles_1.DownloadLinks, { label: "All chromosomes VCF", path: "/release/2.1.1/liftover_grch38/vcf/exomes/gnomad.exomes.r2.1.1.sites.liftover_grch38.vcf.bgz", size: "85.31 GiB", md5: "cff8d0cfed50adc9211d1feaed2d4ca7", associatedFileType: "TBI" })),
                        liftoverExomeChromosomeVcfs.map(({ chrom, size, md5 }) => (
                        // @ts-expect-error TS(2769) FIXME: No overload matches this call.
                        react_1.default.createElement(ui_1.ListItem, { key: chrom },
                            react_1.default.createElement(downloadsPageStyles_1.DownloadLinks, { label: `chr${chrom} sites VCF`, path: `/release/2.1.1/liftover_grch38/vcf/exomes/gnomad.exomes.r2.1.1.sites.${chrom}.liftover_grch38.vcf.bgz`, size: size, md5: md5, associatedFileType: "TBI" })))))),
                react_1.default.createElement(downloadsPageStyles_1.Column, null,
                    react_1.default.createElement("h3", null, "Genomes"),
                    react_1.default.createElement(downloadsPageStyles_1.FileList, null,
                        react_1.default.createElement(ui_1.ListItem, null,
                            react_1.default.createElement(downloadsPageStyles_1.GetUrlButtons, { label: "Sites Hail Table", path: "/release/2.1.1/liftover_grch38/ht/genomes/gnomad.genomes.r2.1.1.sites.liftover_grch38.ht" })),
                        react_1.default.createElement(ui_1.ListItem, null,
                            react_1.default.createElement(downloadsPageStyles_1.DownloadLinks, { label: "All chromosomes VCF", path: "/release/2.1.1/liftover_grch38/vcf/genomes/gnomad.genomes.r2.1.1.sites.liftover_grch38.vcf.bgz", size: "743.06 GiB", md5: "83de3d5b52669f714e810d4fcf047c18", associatedFileType: "TBI" })),
                        liftoverGenomeChromosomeVcfs.map(({ chrom, size, md5 }) => (
                        // @ts-expect-error TS(2769) FIXME: No overload matches this call.
                        react_1.default.createElement(ui_1.ListItem, { key: chrom },
                            react_1.default.createElement(downloadsPageStyles_1.DownloadLinks, { label: `chr${chrom} sites VCF`, path: `/release/2.1.1/liftover_grch38/vcf/genomes/gnomad.genomes.r2.1.1.sites.${chrom}.liftover_grch38.vcf.bgz`, size: size, md5: md5, associatedFileType: "TBI" })))))))),
        react_1.default.createElement(downloadsPageStyles_1.DownloadsSection, null,
            react_1.default.createElement(downloadsPageStyles_1.SectionTitle, { id: "v2-liftover-structural-variants" }, "Structural variants (GRCh38 liftover)"),
            ...
            react_1.default.createElement(downloadsPageStyles_1.FileList, null,
                react_1.default.createElement(ui_1.ListItem, null,
                    react_1.default.createElement(ui_1.ExternalLink, { href: "https://www.ncbi.nlm.nih.gov/sites/dbvarapp/studies/nstd166/" }, "nstd166 (gnomAD Structural Variants)"))))));
};
exports.default = Gnomadv2LiftoverDownloads;
//# sourceMappingURL=GnomadV2LiftoverDownloads.js.map