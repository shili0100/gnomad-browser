...
const MitochondrialVariant_1 = __importDefault(require("../__factories__/MitochondrialVariant"));
const MitochondrialVariantPage_1 = __importDefault(require("./MitochondrialVariantPage"));
...
(0, datasets_1.forAllDatasets)('MitochondrialVariantPage with dataset %s', (datasetId) => {
    (0, globals_1.test)('has no unexpected changes', () => {
        const variant = MitochondrialVariant_1.default.build();
        const { clinvar } = variant, rest = __rest(variant, ["clinvar"]);
        const apiResponse = {
        ...
        const tree = react_test_renderer_1.default.create(react_1.default.createElement(react_router_dom_1.BrowserRouter, null,
            react_1.default.createElement(MitochondrialVariantPage_1.default, { variantId: variant.variant_id, datasetId: datasetId })));
        (0, globals_1.expect)(tree).toMatchSnapshot();
    });
});
//# sourceMappingURL=MitochondrialVariantPage.spec.js.map