...
const sourceFilePaths = (subsectionName, filenamePattern) => {
    ...
    return glob
        ...
        .filter((sourceFilePath) => !sourceFilePath.match(/\.spec\./));
};
...
`;
fs.writeFileSync(OUTPUT_PATH, prettier.format(content, Object.assign(Object.assign({}, prettier.resolveConfig.sync(OUTPUT_PATH)), { filepath: OUTPUT_PATH })));
//# sourceMappingURL=buildHelp.js.map