...
const reactShapePlugin = {
    ...
    run({ fileName, sourceFile, options, text }) {
        ...
        const splitVariableExport = (node, shapeName) => {
            ...
            const newExport = typescript_1.default.factory.createExportDeclaration(undefined, undefined, false, typescript_1.default.factory.createNamedExports([
                typescript_1.default.factory.createExportSpecifier(false, undefined, typescript_1.default.factory.createIdentifier(shapeName)),
            ]));
            updates.push({
                kind: 'insert',
                index: node.end,
    ...
    validate: (0, validateOptions_1.createValidate)(Object.assign(Object.assign({}, validateOptions_1.anyAliasProperty), validateOptions_1.anyFunctionAliasProperty)),
};
function getTypeForTheShape(shapeNode, shapeName, sourceFile, options, isArrayShapeType = false) {
    const shapeTypeVariable = (0, react_props_1.default)(shapeNode.arguments[0], sourceFile, {
