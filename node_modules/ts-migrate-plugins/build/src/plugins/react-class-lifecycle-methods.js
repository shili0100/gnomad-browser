...
function annotateReactComponentLifecycleMethods(sourceFile, sourceText, force = false) {
    ...
    sourceFile.statements.forEach((statement) => {
        if (typescript_1.default.isClassDeclaration(statement) && (0, react_1.isReactClassComponent)(statement)) {
            const heritageType = (0, react_1.getReactComponentHeritageType)(statement);
