...
const addConversionsTransformerFactory = (updates, diags, { anyAlias }) => (context) => {
    ...
    let nodesToConvert;
    const ancestorReplaceMap = new Map();
    return (file) => {
    ...
    function visit(origNode) {
        ...
        ancestorReplaceMap.set(origNode, ancestorShouldBeReplaced === undefined
            ? origNode.kind === typescript_1.default.SyntaxKind.ExpressionStatement
            : origNode.kind === typescript_1.default.SyntaxKind.ExpressionStatement || ancestorShouldBeReplaced);
