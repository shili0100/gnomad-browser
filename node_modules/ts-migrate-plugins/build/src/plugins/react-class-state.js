...
const reactClassStatePlugin = {
    ...
    async run({ fileName, sourceFile, options }) {
        ...
        if (reactClassDeclarations.length === 0)
            return undefined;
        const numComponentsInFile = (0, react_1.getNumComponentsInSourceFile)(sourceFile);
        const usedIdentifiers = (0, identifiers_1.collectIdentifiers)(sourceFile);
        reactClassDeclarations.forEach((classDeclaration) => {
            ...
            const heritageType = (0, react_1.getReactComponentHeritageType)(classDeclaration);
        ...
        return (0, updateSourceText_1.default)(sourceFile.text, updates);
    },
