...
function canHoistExpression(expression, hoistToPos, knownDefinitions) {
    const allIdentifiers = (0, identifiers_1.collectIdentifierNodes)(expression);
...
function hoistStaticClassProperties(sourceFile, sourceText, options) {
    ...
    const knownDefinitions = Object.assign(Object.assign({}, (0, identifiers_1.findKnownImports)(sourceFile)), (0, identifiers_1.findKnownVariables)(sourceFile));
    ...
    return (0, updateSourceText_1.default)(sourceText, updates);
}
